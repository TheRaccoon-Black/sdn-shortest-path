...
# 
# CONTROLLER FAT-TREE - JOHNSON (THREAD POOL FIX)
# Fitur: Pre-Calculated Routing dengan Threading agar tidak freeze.
...
class JohnsonFatTreeController(app_manager.RyuApp):
    ...
    def _build_optimal_topology(self):
        ...
        # Batching 30 detik agar aman untuk K=6 atau K=8
        hub.sleep(30.0) 
