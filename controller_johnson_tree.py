...
class JohnsonTreeController(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(JohnsonTreeController, self).__init__(*args, **kwargs)
    ...
    def _packet_in_handler(self, ev):
        ...
        if dpid == dst_dpid:
            ...
            try:
                path = nx.shortest_path(net, dpid, dst_dpid, method='dijkstra')
            ...
            # =====================================================
                # Error ini bisa terjadi jika topologi belum sepenuhnya ditemukan di awal
                # atau jika link benar-benar putus. Keputusan yang aman adalah Flooding.
                self.logger.warning("Tidak bisa menghitung jalur dari S%s ke S%s. Peta mungkin belum lengkap. Flooding.", dpid, dst_dpid)
                actions = [parser.OFPActionOutput(ofproto.OFPP_FLOOD)]
